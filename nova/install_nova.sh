...
echo "vlan_interface=eth1" 				>> /etc/nova/nova.conf
...
read
nova-manage network create private --fixed_range_v4=192.168.4.32/27 --vlan=100 --num_networks=1 --bridge=br100 --bridge_interface=eth1 --network_size=32
